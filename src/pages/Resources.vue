<template>
  <section class="bg-[#000716] w-full sm:p-10 p-4 h-[900px]">
    ...
    >
      <li
        :class="[
          resource.name === 'Vue Js' ? '!bg-contain' : '',
      ...
      >
        <figure class="flex h-[150px] items-end mb-2 justify-center">
          <div class="font-jetMono rounded-r-lg flex flex-col justify-center">
            <blockquote class="flex flex-col items-center justify-center">
              <p
                class="
                  sm:text-lg
                  xss:text-base
          ...
          items: [
            {
              name: 'Tailwind css',
              imageURL:
                'https://camo.githubusercontent.com/53b9876cd8e38928387c6824043b0e2772b15b1bfdb7f42d0864216abbf3dfe8/68747470733a2f2f7265666163746f72696e6775692e6e7963332e63646e2e6469676974616c6f6365616e7370616365732e636f6d2f7461696c77696e642d6c6f676f2e737667',
          ...
          items: [
            {
              name: 'Vue Js',
              imageURL:
                'https://elepass.io/wp-content/uploads/2018/05/Vue-logo-001.svg',
              speciality:
                'It is a framework which gives best of React and Angular .',
            },
          ],
        },
      },
          ...
          items: [
            {
              ...
              speciality:
                'UI library which is based on best practises of web .',
            },
          ],
        },
      },
    ]
    let allItem = resources.map((e) => {
      return e.type.items
    })
    resources = [
      {
