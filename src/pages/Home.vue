<template>
    <section class="flex flex-col w-[calc(100vw+96px)] z-30">
        ...
        >
            ...
            >
                <h1
                    class="text-6xl text-white xss:text-7xl xs:text-8xl lg:text-9xl font-round"
                    style=""
                >
                    <span
                    ...
                    >
                    <span
                        class="block text-lightBlue-100"
                        style="
                            text-shadow: 0px 0px 10px #9ff, 0px 0px 10px #0ff;
                        "
                        >Singh</span
                    >
                </h1>
                <div class="flex mt-8 md:mt-0 md:flex-shrink-0">
                    ...
                    >
                        <router-link
                            to="/Projects"
                            class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700"
                        >
                            Projects
                        </router-link>
                    </div>
                    ...
                    >
                        <a
                            href="#"
                            class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-blue-600 bg-white border border-transparent rounded-md hover:bg-indigo-50"
                        >
                            Skills
                        </a>
                    </div>
        ...
        >
            <article class="bg-white dark:bg-green-600 p-4 xss:rounded-lg font-bold minh100px]">
                <h1 class="text-xl text-blue-500 dark:text-white">
                    ...
                    Computers. I am self-taught developer and Check out What I
                    am Doing!
                </h1>
            </article>
        </section>
